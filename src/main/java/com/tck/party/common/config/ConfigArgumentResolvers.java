...
public class ConfigArgumentResolvers {
    ...
    private void addArgumentResolvers() {
        ...
        PartyHandlerMethodArgumentResolver partyHandlerMethodArgumentResolver =
                getPartyHandlerMethodArgumentResolver(argumentResolvers);
        ...
        myArgumentResolvers.add(partyHandlerMethodArgumentResolver);
     ...
     */
    private PartyHandlerMethodArgumentResolver getPartyHandlerMethodArgumentResolver(
        ...
        return new PartyHandlerMethodArgumentResolver(requestResponseBodyMethodProcessor,
