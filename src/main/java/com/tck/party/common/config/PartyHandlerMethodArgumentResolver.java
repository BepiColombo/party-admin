 ...
 */
public class PartyHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
     ...
     * 全参构造
     */
    public PartyHandlerMethodArgumentResolver(RequestResponseBodyMethodProcessor requestResponseBodyMethodProcessor,
